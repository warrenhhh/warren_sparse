...
def test_recommend():
    ...
    assert test_recommend_matrix[1, 1] == 1  # using assert to check this is correct
...
def test_add_movie():
    ...
    assert test_add_movie_matrix[1, 2] == 2  # using assert to check this is correct
...
def test_to_dense():
    ...
    assert dense_matrix[1, 1] == 1  # using assert to check this is correct
...
def test_sparse_matrix():
    ...
    assert test_matrix[1, 2] == 2  # using assert to check this is correct
